...
// DETECT PHASE
constexpr float DETECT_LOCK_FREQ = 0.832;           // 0.832,
constexpr float DETECT_TRAP_FREQ = 1.066;           // 0.832, 1.066, 1.299, 1.533, 1.767, 2.000, 2.234*, 2.468, 2.701, 2.935, 3.169 (0->5 in 0.5 [xGAMMA])
...
constexpr float DETECT_C_FIELD = 0; // 100mA/V
...
double u_WAVE_pi_power = -13.1; //-13.1 for pi pulse
